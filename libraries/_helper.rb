...
EOH
    ...
    def executor
      ...
      options = {}.tap do |h|
        ...
        h[:cli_credentials] = cli_credentials if cli_credentials_given?
      end
    ...
    #
    # Username/password used when invoking cli
    #
    # @return [Array]
    #
    def cli_credentials
    ...
    def cli_credentials_given?
      node['jenkins']['executor']['cli_credentials'].respond_to?(:each)
    end
