...
property :parameters,
          Hash,
          default: {}
property :stream_job_output,
          [true, false],
          default: true
property :wait_for_completion,
          [true, false],
          default: true
...
#
# Create a new Jenkins job with the current resource's name
...
#
# Delete a Jenkins job with the current resource's name. If
